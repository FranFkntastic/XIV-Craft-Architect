...
public static class CraftSettingsKeyMap
{
    private static readonly Dictionary<string, CraftSettingsKey> StorageKeys = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["market.auto_fetch_prices"] = CraftSettingsKey.AutoFetchMarketPrices,
        ["market.auto_fetch_on_rebuild"] = CraftSettingsKey.AutoFetchMarketPrices,
        ...
        ["Market.AutoFetchPrices"] = CraftSettingsKey.AutoFetchMarketPrices,
        ["Market.AutoFetchOnRebuild"] = CraftSettingsKey.AutoFetchMarketPrices,
