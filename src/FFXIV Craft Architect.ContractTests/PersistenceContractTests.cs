...
public sealed class PersistenceContractTests
{
    ...
    [Fact]
    public async Task ZeroMaterialBonusPayrollDraftSurvivesPersistenceRoundTrip()
    {
        ...
        await service.GetOrCreateDraftAsync(
            ...
            sourcePlanName: "Zero material bonus plan",
        ...
        Assert.Equal(TradePaymentContractMode.LaborStandard, reloaded.ActivePaymentContract);
    }
